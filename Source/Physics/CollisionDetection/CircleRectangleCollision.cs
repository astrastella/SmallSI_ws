...
namespace Physics.CollisionDetection
{
    internal static class CircleRectangleCollision
    {
        internal static CollisionInfo[] GetCollisionPoints(RigidCircle circle, RigidRectangle rectangle)
        {
            ...
            // Calculate collision normal (from circle center to closest point)
            ...
            Vec2D contactPoint = circle.Center + normal * circle.Radius;
            
            return new CollisionInfo[] 
            { 
                new CollisionInfo(contactPoint, normal, depth, rectangle, circle) 
            };
        }
